	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				...
				<div class="logo">
					<a href="index.php"><center><h1>FoodCubo </h1></center></a>
					<p class="text-center"><center><h5>Getting Hungry !! Just Let Us Know</h5></center></p>

				</div>
				<a href="index.php"><img src="images/food.png" style="width: 120px; height: 70px; position: absolute; left: 0px; top: 20px;" alt=""></a>
				<div class="queries">
					<p>Questions? Call us Toll-free!<span>1800-0000-0000</span><label>(24X7)</label></p>
