		...
		<div class="ordering-section" id="Order">
			<div class="container">
				<div class="ordering-section-head text-center wow bounceInRight" data-wow-delay="0.4s">
					<h3>Order Food at your Finger Tips</h3>
				...
				<div class="ordering-section-grids">
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							<i class="one"></i><br>
							<i class="one-icon"></i>
							<p>Choose <span>Your Delicacy</span></p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							<i class="two"></i><br>
							<i class="two-icon"></i>
							<p>Choose <span>Restaurant</span></p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							...
							<p><span>Pay On Delievery</span> OR<span> Online</span></p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
				...
				<div class="col-md-8 top-cuisines">
					...
					<div class="top-cuisine-grids">
						<div class="top-cuisine-grid wow bounceIn" data-wow-delay="0.4s">
						    <a href="#"><img src="images/0.jpg" class="img-responsive" alt="" /> </a>
				...
				<div class="container">
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							...
							<p>Guranteed service assistance and food delievery at your door steps. </p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							...
							<p>Do secure payments with our various payment methods including C.O.D.  </p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 service-section-bottom-grid wow bounceIn "data-wow-delay="0.2s">
						...
						<div class="icon-data">
							<h4>Quick Food Near You</h4>
							<p>One click ordering from the food joints near you.</p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
